        ...
        <router-link :to="url(section)" class="threeSmall">
          ...
          <div class="list_img">
            <ul>
              ...
              <li>
                <img v-lazy.container="section.titlepic2">
              </li>
              <li>
                <img v-lazy.container="section.titlepic3">
              </li>
            </ul>
          </div>
          <!-- <list-info :json='section'></list-info> -->
...
export default {
  ...
  methods: {
    ...
    url(item) {
      return `/detail?classid=${item.classid}&id=${item.id}&datafrom=${
        item.datafrom
      }`;
    },
    saveData(json) {
...
.listItem {
  li {
    margin: 0 0.4rem;
    border-bottom: 1px solid hsla(0, 0%, 87%, 0.6);
  }
  a {
    display: block;
    width: 100%;
